...
int
justine::sampleclient::MyShmClient::init (boost::asio::ip::tcp::
					  socket & socket)
{
...
void
justine::sampleclient::MyShmClient::car (boost::asio::ip::tcp::
					 socket & socket, int id, unsigned *f,
	  ...
	  if (path.size () > 1)
	    {
	      ...
	      std::copy (path.begin (), path.end (),
			 ...
			 osmium::unsigned_object_id_type > (std::cout,
							    " -> "));
...
void
justine::sampleclient::MyShmClient::start10 (boost::asio::
					     io_service & io_service,
					     const char *port)
{
